    ...
    module Base
      module Errors
        ...
        def error_list_html(ignore)
          ...
          #   list_elements << template.content_tag(:li, Formtastic::Utils.html_safe(error.html_safe))
          # end
          # template.content_tag(:ul, Formtastic::Utils.html_safe(list_elements.join("\n")), :class => error_class)
        end
        ...
        def error_first_html(inline_or_block = :inline)
          ...
          template.content_tag(:span, errors.first.untaint, :class => error_class)
        end
